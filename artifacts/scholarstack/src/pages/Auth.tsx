          ...
          {step === "email_otp" && (
            <div>
              ...
              <div className="space-y-4">
                ...
                <div className={`p-3 rounded-xl bg-yellow-500/8 border border-yellow-500/20 text-xs text-yellow-300 leading-relaxed`}>
                  <strong>Setup required:</strong> In Supabase → Auth → Email Templates → "Confirm signup" → add <code className="bg-black/30 px-1 rounded">{"{{ .Token }}"}</code> to the email body so users see the code.
                </div>
              </div>
            </div>
          )}
